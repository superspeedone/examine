				                 ...
				                 <div class="col-lg-12">
		                              <section class="panel">
		                                  ...
		                                  <div class="panel-body">
				                              <form action="manage/users!edit.action"  method="post"  class="form-horizontal" role="form">
				                                  <input name="id" type="hidden" value="<s:property value='#parameters.id'/>"/>
				                                  <div class="form-group">
				                                      <label for="inputLoginname" class="col-lg-1 control-label">账号</label>
				                                      <div class="col-lg-3">
				                                          <s:textfield type="text" cssClass="form-control" id="inputLoginname" name="login_name" disabled="true" />
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
				                                      <label for="inputRealname" class="col-lg-1 control-label">账号名</label>
				                                      <div class="col-lg-3">
				                                          <s:textfield type="text" cssClass="form-control" id="inputRealname" name="real_name" placeholder="" maxlength="30" required=""/>
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
				                                      <label for="inputPassword1" class="col-lg-1 control-label">密码</label>
				                                      <div class="col-lg-3">
				                                          <s:textfield type="password" cssClass="form-control" id="inputPassword1" name="password" placeholder="" required=""/>
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
				                                  ...
				                                  <div class="form-group">
				                                      ...
				                                      <div class="col-lg-3">
				                                         <s:select name="op_type" list="#{'0':'管理员','1':'教师','2':'学生'}"  listKey="key" listValue="value"
															 value="op_type" cssClass="form-control m-bot6" required="">
														 </s:select>
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
