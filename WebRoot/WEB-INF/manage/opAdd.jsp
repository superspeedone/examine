				                 ...
				                 <div class="col-lg-12">
		                              <section class="panel">
		                                  ...
		                                  <div class="panel-body">
				                              <form action="manage/op/list!add.action"  method="post"  class="form-horizontal" role="form">
				                                  <div class="form-group">
				                                      <label for="inputLoginname" class="col-lg-1 control-label">登陆名</label>
				                                      <div class="col-lg-3">
				                                          <input type="text" class="form-control" id="inputLoginname" name="opVO.login_name" placeholder="最大长度30" maxlength="30" required="">
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
				                                      <label for="inputRealname" class="col-lg-1 control-label">姓名</label>
				                                      <div class="col-lg-3">
				                                          <input type="text" class="form-control" id="inputRealname" name="opVO.real_name" placeholder="" maxlength="30" required="">
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
				                                      <label for="inputPassword1" class="col-lg-1 control-label">密码</label>
				                                      <div class="col-lg-3">
				                                          <input type="password" class="form-control" id="inputPassword1" name="opVO.password" placeholder="" required="">
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
				                                  ...
				                                  <div class="form-group">
				                                      ...
				                                      <div class="col-lg-3">
				                                          <select class="form-control m-bot6" name="opVO.op_type" required="">
				                                  ...
				                                  <div class="form-group">
				                                      <div class="col-lg-offset-1 col-lg-6">
				                                          ...
				                                          <a class="btn btn-info" href="manage/op/list.action" style="width:100px;">返回</a>
				                                          <label style="color:green;font-size:14px;margin-left:15px;"><strong>${eMessage}</strong></label>
				                                      </div>
				                                  </div>
				                              </form>
				                          </div>
