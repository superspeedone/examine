				                 ...
				                 <div class="col-lg-12">
		                              <section class="panel">
		                                  ...
		                                  <div class="panel-body">
				                              <form action="manage/op/list!edit.action"  method="post"  class="form-horizontal" role="form">
				                                  <input name="opVO.id" type="hidden" value="<s:property value='#parameters.id'/>"/>
				                                  <div class="form-group">
				                                      <label for="inputLoginname" class="col-lg-1 control-label">账号</label>
				                                      <div class="col-lg-3">
				                                          <s:textfield type="text" cssClass="form-control" id="inputLoginname" name="opVO.login_name" disabled="true" />
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
				                                      <label for="inputRealname" class="col-lg-1 control-label">账号名</label>
				                                      <div class="col-lg-3">
				                                          <s:textfield type="text" cssClass="form-control" id="inputRealname" name="opVO.real_name" placeholder="" maxlength="30" required=""/>
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
				                                      <label for="inputPassword1" class="col-lg-1 control-label">密码</label>
				                                      <div class="col-lg-3">
				                                          <s:textfield type="password" cssClass="form-control" id="inputPassword1" name="opVO.password" placeholder="" required=""/>
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
