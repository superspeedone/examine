				                 ...
				                 <div class="col-lg-12">
		                              <section class="panel">
		                                  ...
		                                  <div class="panel-body">
				                              <form action="manage/users!add.action"  method="post" class="form-horizontal" >
				                                  <div class="form-group">
				                                      <label for="inputLoginname" class="col-lg-1 control-label">账号</label>
				                                      <div class="col-lg-3">
				                                          <input type="text" class="form-control" id="inputLoginname" name="login_name" placeholder="" maxlength="30" required="">
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
				                                  ...
				                                  <div class="form-group">
				                                      ...
				                                      <div class="col-lg-3">
				                                          <input type="password" class="form-control" id="inputPassword1" nane="password" placeholder="" required="">
				                                      </div>
				                                  </div>
				                                  <div class="form-group">
