...
var TableInit = function() {
	...
	oTableInit.queryParams = function(params) {
	 ...
	 //自定义行样式
	oTableInit.rowStyle = function(value, row, index) {
	   if (row % 2 == 0) {
		   return {
			    classes: 'text-nowrap another-class',
			    css: {"font-family": "微软雅黑","color": "black","background-color": "#eff7de"}
			};
	   }else{
		   return {
			    classes: 'text-nowrap another-class',
			    css: {"font-family": "微软雅黑","color": "black","background-color": "#f9fbf4"}
			};
	   }
	};
